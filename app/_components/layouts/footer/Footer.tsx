            ...
            <div
                ...
                <div className="max-w-[346px]">
                    ...
                    <div className="flex items-start gap-2.5 mt-4 lg:mt-6">
                        <i className="icon-marker-brand"></i>
                    ...
                    <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                        <i className="icon-headset text-brand1"></i>
                        <div className="font-lato text-medium text-blue-300"><span
                    ...
                    <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                        <i className="icon-time-fast text-brand1"></i>
                        <div className="font-lato text-medium text-blue-300"><span
                ...
                <div className="pt-4 md:pt-0">
                    <div
                        className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Company <i
                        className="icon-down-dark text-[24px] inline-block sm:hidden"></i></div>
                ...
                <div className="pt-4 md:pt-0">
                    <div
                        className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Information <i
                        className="icon-down-dark text-[24px] inline-block sm:hidden"></i></div>
                    <ul className="hidden md:flex flex-col gap-2.5">
                ...
                <div className="pt-4 md:pt-0">
                    ...
                    <div className="flex items-center gap-6 justify-center xl:justify-start pt-4 lg:pt-5">
                        <Link href="#"><ImageView src="/images/va724oeh 1.png" alt="Download app from apple store" width={129} height={39}/></Link>
                        <Link href="#"><ImageView src="/images/17kw6njp 1.png" alt="Download app from google play" width={129} height={39}/></Link>
                    </div>
                    ...
                    <div className="flex justify-center xl:justify-start pt-4 lg:pt-5">
                        <ImageView src="/images/payment-method%201.png" alt="payment methods" width={225} height={33}/>
                    </div>
                </div>
            </div>
