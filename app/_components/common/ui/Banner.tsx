...
export default function Banner() {
    ...
    <h2 className="text-heading5 sm:text-heading4 lg:text-heading2 xl:text-heading1 2xl:text-display2 text-blue-300 mb-[33px]"></h2>
        <p className="text-gray-500 mb-[68px] hidden md:inline-block"> </p>
        <form method="post" action="#"
    className="hidden lg:flex rounded-[30px] pl-[26px] lg:w-[442px] w-full bg-white items-center">
    <i className="icon-paper-plane text-[24px]"></i>
    ...
    className="text-white hover:bg-green-300 bg-green-200 rounded-[30px] px-[18px] py-2 sm:px-[37px] sm:py-[15px] cursor-pointer text-heading6"/>
        ...
        <ImageView src='/images/fresh-apples.png' className="m-w-[50%]" alt={"banner"} height={538} width={717} />
    </div>
