...
import {ChevronDown, ChevronUp, Eye, Heart, ShoppingCart, Shuffle} from "lucide-react";
...
export default function BestSellerCard({data}:Props)
{
    return (
                            ...
                            </div>
                            {
                                data.total && data.sold ?
                                    <>
                                        ...
                                        <div
                                            className="mt-2.5 font-lato text-blue-300 text-xsmall">Sold: {data.sold}/{data.total}</div>
